    ...
    <nav class="navbar navbar-b navbar-trans navbar-expand-lg" id="mainNav">
        <div class="container">
            ...
            <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
                <ul class="navbar-nav">
                    <li class="nav-item book-now"><a class="nav-link js-scroll" href="index.php">Home</a></li>
...
<section id="reservation" class="zr-theme-reservation-area section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center">
                <h2>Reliable Gold Vehicle History Report</h2>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <form action="<?php echo PAYPAL_URL; ?>" method="post" id="paypal_form">
                ...
                <input style="display:none" type="number" required name="amount" id="amount" value="59.99" readonly>
                ...
                <label class="form-control font-weight-bold">Package: Gold || Price: $59.99</label>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                    <div class="footer-widget">
                        ...
                        <ul>
                            <li><a href="index.php#slider-home">Home</a></li>
                            <li><a href="index.php#about">About</a></li>
                            <li><a href="index.php#services">Services</a></li>

                            <li><a href="index.php#packages">Our Packages</a></li>

                            <li><a href="index.php#reservation">Buy Now</a></li>
                        </ul>
                    </div>
                </div>
