...
<section id="reservation" class="zr-theme-reservation-area section-padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center">
                <h2>Reliable Bronze Vehicle History Report</h2>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <form action="<?php echo PAYPAL_URL; ?>" method="post" id="paypal_form">
                ...
                <input style="display:none" type="number" required name="amount" id="amount" value="35.99" readonly>
                ...
                <!-- comment by adil -->
                <label class="form-control font-weight-bold">Package: Bronze || Price: $35.99</label>
